    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            [
                'name' => 'financial.view',
                'type' => 'on-off',
                'description' => 'View accounting dashboard and reports',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'type' => 'crud',
                'description' => 'Manage chart of accounts, journals and book closing',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'name' => 'accounting.dashboard.view',
                'type' => 'on-off',
            ...
            [
                'name' => 'accounting.cash.manage',
                'type' => 'crud',
                'description' => 'Manage cash movement journals',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
            ...
            [
                'name' => 'accounting.close.manage',
                'type' => 'on-off',
                'description' => 'Close accounting books',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ...
        $managerPerms = [
            ...
            'customers.manage' => ['read', 'update', 'delete'],
            'financial.view' => ['on'],
            'financial.manage' => ['create', 'read', 'update', 'delete'],
            'accounting.dashboard.view' => ['on'],
            'accounting.accounts.manage' => ['create', 'read', 'update', 'delete'],
            'accounting.journal.manage' => ['create', 'read', 'update', 'delete'],
            'accounting.cash.manage' => ['create', 'read', 'update', 'delete'],
            'accounting.reports.view' => ['on'],
            'accounting.close.manage' => ['on'],
